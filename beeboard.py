...
class PySwitch(QAbstractButton):
    ...
    def paintEvent(self, e):
        ...
        if self.text():
            painter.setPen(QColor("black")) # Yazı rengi
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pin22Button.setGeometry(QRect(1033, 45, 21, 20))
        ...
        self.pin23Button.setGeometry(QRect(1148, 45, 21, 20))
        ...
        self.pin24Button.setGeometry(QRect(1262, 45, 21, 20))
        ...
        self.pin25Button.setGeometry(QRect(1377, 45, 21, 20))
        ...
        self.RFIDButton.setGeometry(QRect(1475, 290, 21, 20))
        ...
        self.pin26Button.setGeometry(QRect(1383, 600, 21, 20))
        ...
        self.pin27Button.setGeometry(QRect(1265, 600, 21, 20))
        ...
        self.pin28Button.setGeometry(QRect(1150, 600, 21, 20))
        ...
        self.pin29Button.setGeometry(QRect(1035, 600, 21, 20))
        ...
        self.loadcellButton.setGeometry(QRect(480, 600, 21, 20))
        ...
        self.fullsetButton = PySwitch(self.pinControls)
        self.fullsetButton.setObjectName(u"fullsetButton")
        self.fullsetButton.setGeometry(QRect(10, 40, 201, 21))
        self.groupBox = QGroupBox(self.centralwidget)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(0, 230, 231, 121))
...
"color: black; font: bold;")
        ...
        self.logScreen.setGeometry(QRect(1000, 160, 311, 271))
        self.logScreen.setAutoFillBackground(False)
        self.logScreen.setStyleSheet(u"background-color: black; color: white; font-family: Consolas;")
        self.logScreen.setReadOnly(True)
        self.pin22Label = QLabel(self.centralwidget)
        self.pin22Label.setObjectName(u"pin22Label")
        self.pin22Label.setGeometry(QRect(1013, 75, 71, 41))
        ...
        self.pin23Label.setGeometry(QRect(1128, 75, 71, 41))
        ...
        self.pin24Label.setGeometry(QRect(1243, 75, 71, 41))
        ...
        self.pin25Label.setGeometry(QRect(1358, 75, 71, 41))
        ...
        self.RFIDLabel.setGeometry(QRect(1456, 320, 71, 41))
        ...
        self.pin26Label.setGeometry(QRect(1358, 550, 71, 41))
        ...
        self.pin27Label.setGeometry(QRect(1243, 550, 71, 41))
        ...
        self.pin28Label.setGeometry(QRect(1128, 550, 71, 41))
        ...
        self.pin29Label.setGeometry(QRect(1013, 550, 71, 41))
        ...
        self.loadcellLabel.setGeometry(QRect(457, 560, 71, 31))
...
"}")
        ...
        self.clearButton.setGeometry(QRect(1000, 430, 311, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pinControls.setTitle(QCoreApplication.translate("MainWindow", u"Fullset Kontrol", None))
        self.fullsetButton.setText(QCoreApplication.translate("MainWindow", u"S\u00fcrekli Veri G\u00f6nderimi Aktif", None))
        ...
        self.continuousCheckBox.setText(QCoreApplication.translate("MainWindow", u"S\u00fcrekli Veri Al\u0131m\u0131 Aktif", None))
